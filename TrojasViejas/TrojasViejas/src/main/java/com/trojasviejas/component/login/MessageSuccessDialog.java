...
public class MessageSuccessDialog extends javax.swing.JDialog {
    ...
    public MessageSuccessDialog(JFrame window) {
        super(window, true);
        this.window = window;
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/successDialog.png"))); // NOI18N

        lblTitle.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        lblTitle.setForeground(new java.awt.Color(0, 184, 82));
